...
if (isset($_POST['submit'])) {
    ...
    $sql = 'select * from usuario where nome like "%' . $pesqnome . '%"';
} else {
    $pesqnome = '';
}
?>
        ...
        <div class="container">
            ...
            <div class="container">
                <div class="jumbotron" style="padding-top: 2px; padding-bottom: 12px;">
                    <h3 class="text-center">Pesquisa Usuário</h3>
            ...
            <button type="button" class="btn btn-primary">
                <a href="caduser.php" style="color: white;"> Inclusão</a></button>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col" style="display:none;">Senha</th>
                ...
                <tbody>
                    ...
                    if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                           ...
                           <td>" . $row['id'] . "</td>
                           <td>" . $row['login'] . "</td>
                           <td style='display:none;'>" . $row['senha'] . "</td>
                           <td>" . $row['nome'] . "</td>
                           <td>" . $row['email'] . "</td>
                           <td>" . $row['master'] . "</td>
                           <td>
                           <button type='button' class='btn btn-success'>
                           <a href='cadupdate.php?updateid=" . $id . "' style='color:white;'> Altera </a> </button>
                           <button type='button' class='btn btn-danger'>
                           <a href='caddelete.php?deleteid=" . $id . "' style='color:white;'> Exclui </a> </button> </td>";
