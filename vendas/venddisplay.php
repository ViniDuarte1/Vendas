        ...
        <div class="container">
            ...
            <div class="container">
                <div class="jumbotron" style="padding-top: 2px; padding-bottom: 12px;">
                    <h3 class="text-center">Pesquisa Vendedores</h3>
            ...
            <button type="button" class="btn btn-primary">
                <a href="venduser.php" style="color: white;"> Inclusão</a></button>
                ...
                <tbody>
                    ...
                    if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                           ...
                           <a href='vendupdate.php?updateid=" . $id . "' style='color:white;'> Altera </a> </button>
                           <button type='button' class='btn btn-danger'>
                           <a href='venddelete.php?deleteid=" . $id . "' style='color:white;'> Exclui </a> </button> </td>";
